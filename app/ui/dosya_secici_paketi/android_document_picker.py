...
class AndroidDocumentPicker:
    ...
    def _bind_activity_result(self) -> None:
        ...
        API 34 uyumluluk notu:
        - Tekrar bind edilmesini önlemek için _is_bound kontrolü vardır.
        """
        if platform != "android":
            return
    ...
    def open_picker(self) -> None:
        ...
        API 34 uyumluluk notu:
        - ACTION_OPEN_DOCUMENT kullanılır
        - Persistable read/write URI izinleri talep edilir
        """
        if platform != "android":
        ...
        try:
            ...
            if current_activity is None:
                self._debug("picker açılamadı: activity boş")
                return
    ...
    def _on_activity_result(self, request_code, result_code, intent) -> None:
        ...
        API 34 uyumluluk notu:
        - URI null kontrolleri korunur
        - Persistable permission alınmaya çalışılır
        """
