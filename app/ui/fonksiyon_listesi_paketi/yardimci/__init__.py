# -*- coding: utf-8 -*-
"""
DOSYA: app/ui/fonksiyon_listesi_paketi/yardimci/__init__.py

ROL:
- Yardımcı yöneticisine lazy erişim sağlar
- Import yükünü azaltır
- Circular import riskini minimize eder
- Yardımcı alt paketini dış dünyaya yalnızca yönetici üzerinden açar

MİMARİ:
- Doğrudan yardimci modülü dışa açılmaz
