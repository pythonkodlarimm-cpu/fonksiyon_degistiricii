...
ROL:
- Sistem ve app state akışı için tek noktadan erişim sağlayan yönetici sınıfıdır
- Root sistem/app state mixin sınıfını güvenli biçimde döndürür
...
class RootSistemVeAppStateYoneticisi:
    """
