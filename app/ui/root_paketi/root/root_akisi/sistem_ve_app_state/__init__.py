# -*- coding: utf-8 -*-
"""
DOSYA: app/ui/root_paketi/root/root_akisi/sistem_ve_app_state/__init__.py

ROL:
- sistem_ve_app_state paketinin dışa açılan ana giriş noktasıdır
- Root sistem ve app state mixin sınıfını lazy import ile erişilebilir kılar
...
KULLANIM:
- from app.ui.root_paketi.root.root_akisi.sistem_ve_app_state import RootSistemVeAppStateMixin
...
__all__ = ["RootSistemVeAppStateMixin"]
...
def __getattr__(name: str):
    ...
    """
    if name == "RootSistemVeAppStateMixin":
        from .sistem_ve_app_state import RootSistemVeAppStateMixin

        globals()["RootSistemVeAppStateMixin"] = RootSistemVeAppStateMixin
        return RootSistemVeAppStateMixin
