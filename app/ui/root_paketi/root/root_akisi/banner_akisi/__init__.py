# -*- coding: utf-8 -*-
"""
DOSYA: app/ui/root_paketi/root/root_akisi/banner_akisi/__init__.py

ROL:
- banner_akisi paketinin dışa açılan ana giriş noktasıdır
- Root banner akışı mixin sınıfını lazy import ile erişilebilir kılar
...
KULLANIM:
- from app.ui.root_paketi.root.root_akisi.banner_akisi import RootBannerAkisiMixin
...
def __getattr__(name: str):
    ...
    """
    if name == "RootBannerAkisiMixin":
        from .banner_akisi import RootBannerAkisiMixin

        globals()["RootBannerAkisiMixin"] = RootBannerAkisiMixin
        return RootBannerAkisiMixin
