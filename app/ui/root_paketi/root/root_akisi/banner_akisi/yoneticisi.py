# -*- coding: utf-8 -*-
"""
DOSYA: app/ui/root_paketi/root/root_akisi/banner_akisi/yonetici.py

ROL:
- Banner akışı için tek noktadan erişim sağlayan yönetici sınıfıdır
- Root banner mixin sınıfını güvenli biçimde döndürür
...
KULLANIM:
- yonetici = RootBannerAkisiYoneticisi()
...
class RootBannerAkisiYoneticisi:
    """
    Banner akışı modülü için merkezi erişim yöneticisi.
    """

    modul_yolu = "app.ui.root_paketi.root.root_akisi.banner_akisi.banner_akisi"
    sinif_adi = "RootBannerAkisiMixin"
    ...
    def _yukle_modul(self):
        ...
        try:
            ...
            print(f"[ROOT_BANNER_AKISI] Modül yüklenemedi: {self.modul_yolu}")
    ...
    def _yukle_sinif(self):
        ...
        try:
            ...
            if cls is None:
                print(f"[ROOT_BANNER_AKISI] Sınıf bulunamadı: {self.sinif_adi}")
                self._sinif_cache_temizle()
                return None
            ...
            print(f"[ROOT_BANNER_AKISI] Sınıf alınamadı: {self.sinif_adi}")
            print(traceback.format_exc())
            self._sinif_cache_temizle()
            return None
    ...
    def modul(self):
        """
        Banner akışı modül nesnesini döndürür.
    ...
    def mixin_sinifi(self):
        """
        RootBannerAkisiMixin sınıfını döndürür.
    ...
    def ornek_olustur(self, *args, **kwargs):
        ...
        try:
            ...
            print("[ROOT_BANNER_AKISI] Mixin örneği oluşturulamadı.")
            print(traceback.format_exc())
            return None