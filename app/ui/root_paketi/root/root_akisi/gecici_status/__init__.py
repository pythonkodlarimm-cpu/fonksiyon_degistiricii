# -*- coding: utf-8 -*-
"""
DOSYA: app/ui/root_paketi/root/root_akisi/gecici_status/__init__.py

ROL:
- gecici_status paketinin dışa açılan ana giriş noktasıdır
- Root geçici status mixin sınıfını lazy import ile erişilebilir kılar
...
KULLANIM:
- from app.ui.root_paketi.root.root_akisi.gecici_status import RootGeciciStatusMixin
...
def __getattr__(name: str):
    ...
    """
    if name == "RootGeciciStatusMixin":
        from .gecici_status import RootGeciciStatusMixin

        globals()["RootGeciciStatusMixin"] = RootGeciciStatusMixin
        return RootGeciciStatusMixin
