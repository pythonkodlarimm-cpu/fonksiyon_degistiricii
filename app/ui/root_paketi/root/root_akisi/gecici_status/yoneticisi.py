# -*- coding: utf-8 -*-
"""
DOSYA: app/ui/root_paketi/root/root_akisi/gecici_status/yonetici.py

ROL:
- Geçici status akışı için tek noktadan erişim sağlayan yönetici sınıfıdır
- Root geçici status mixin sınıfını güvenli biçimde döndürür
...
KULLANIM:
- yonetici = RootGeciciStatusYoneticisi()
...
class RootGeciciStatusYoneticisi:
    """
    Geçici status modülü için merkezi erişim yöneticisi.
    """

    modul_yolu = "app.ui.root_paketi.root.root_akisi.gecici_status.gecici_status"
    sinif_adi = "RootGeciciStatusMixin"
    ...
    def _yukle_modul(self):
        ...
        try:
            ...
            print(f"[ROOT_GECICI_STATUS] Modül yüklenemedi: {self.modul_yolu}")
    ...
    def _yukle_sinif(self):
        ...
        try:
            ...
            if cls is None:
                print(f"[ROOT_GECICI_STATUS] Sınıf bulunamadı: {self.sinif_adi}")
                self._sinif_cache_temizle()
                return None
            ...
            print(f"[ROOT_GECICI_STATUS] Sınıf alınamadı: {self.sinif_adi}")
            print(traceback.format_exc())
            self._sinif_cache_temizle()
            return None
    ...
    def modul(self):
        """
        Geçici status modül nesnesini döndürür.
    ...
    def mixin_sinifi(self):
        """
        RootGeciciStatusMixin sınıfını döndürür.
    ...
    def ornek_olustur(self, *args, **kwargs):
        ...
        try:
            ...
            print("[ROOT_GECICI_STATUS] Mixin örneği oluşturulamadı.")
            print(traceback.format_exc())
            return None