# -*- coding: utf-8 -*-
"""
DOSYA: app/ui/root_paketi/root/root_akisi/dil_akisi/__init__.py

ROL:
- dil_akisi paketinin dışa açılan ana giriş noktasıdır
- Root dil akışı mixin sınıfını lazy import ile erişilebilir kılar
...
KULLANIM:
- from app.ui.root_paketi.root.root_akisi.dil_akisi import RootDilAkisiMixin
...
def __getattr__(name: str):
    ...
    """
    if name == "RootDilAkisiMixin":
        from .dil_akisi import RootDilAkisiMixin

        globals()["RootDilAkisiMixin"] = RootDilAkisiMixin
        return RootDilAkisiMixin
