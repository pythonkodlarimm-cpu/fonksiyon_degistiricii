# -*- coding: utf-8 -*-
"""
DOSYA: app/ui/root_paketi/root/root_akisi/dil_akisi/yonetici.py

ROL:
- Dil akışı için tek noktadan erişim sağlayan yönetici sınıfıdır
- Root dil akışı mixin sınıfını güvenli biçimde döndürür
...
KULLANIM:
- yonetici = RootDilAkisiYoneticisi()
...
class RootDilAkisiYoneticisi:
    """
    Dil akışı modülü için merkezi erişim yöneticisi.
    """

    modul_yolu = "app.ui.root_paketi.root.root_akisi.dil_akisi.dil_akisi"
    sinif_adi = "RootDilAkisiMixin"
    ...
    def _yukle_modul(self):
        ...
        try:
            ...
            print(f"[ROOT_DIL_AKISI] Modül yüklenemedi: {self.modul_yolu}")
    ...
    def _yukle_sinif(self):
        ...
        try:
            ...
            if cls is None:
                print(f"[ROOT_DIL_AKISI] Sınıf bulunamadı: {self.sinif_adi}")
                self._sinif_cache_temizle()
                return None
            ...
            print(f"[ROOT_DIL_AKISI] Sınıf alınamadı: {self.sinif_adi}")
            print(traceback.format_exc())
            self._sinif_cache_temizle()
            return None
    ...
    def modul(self):
        """
        Dil akışı modül nesnesini döndürür.
    ...
    def mixin_sinifi(self):
        """
        RootDilAkisiMixin sınıfını döndürür.
    ...
    def ornek_olustur(self, *args, **kwargs):
        ...
        try:
            ...
            print("[ROOT_DIL_AKISI] Mixin örneği oluşturulamadı.")
            print(traceback.format_exc())
            return None