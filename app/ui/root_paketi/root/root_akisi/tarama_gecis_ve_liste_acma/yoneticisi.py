# -*- coding: utf-8 -*-
"""
DOSYA: app/ui/root_paketi/root/root_akisi/tarama_gecis_ve_liste_acma/yonetici.py

ROL:
- Tarama geçiş ve liste açma akışı için tek noktadan erişim sağlayan yönetici sınıfıdır
- Root tarama geçiş mixin sınıfını güvenli biçimde döndürür
...
KULLANIM:
- yonetici = RootTaramaGecisVeListeAcmaYoneticisi()
...
class RootTaramaGecisVeListeAcmaYoneticisi:
    """
    Tarama geçiş ve liste açma modülü için merkezi erişim yöneticisi.
    """
    ...
    sinif_adi = "RootTaramaGecisVeListeAcmaMixin"
    ...
    def _yukle_modul(self):
        ...
        try:
            ...
            print(
                "[ROOT_TARAMA_GECIS_VE_LISTE_ACMA] "
    ...
    def modul(self):
        """
        Tarama geçiş ve liste açma modül nesnesini döndürür.
    ...
    def mixin_sinifi(self):
        """
        RootTaramaGecisVeListeAcmaMixin sınıfını döndürür.
