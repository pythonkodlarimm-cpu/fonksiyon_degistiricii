# -*- coding: utf-8 -*-
"""
DOSYA: app/ui/root_paketi/root/root_akisi/editor_state/__init__.py

ROL:
- editor_state paketinin dışa açılan ana giriş noktasıdır
- Root editör state mixin sınıfını lazy import ile erişilebilir kılar
...
KULLANIM:
- from app.ui.root_paketi.root.root_akisi.editor_state import RootEditorStateMixin
...
def __getattr__(name: str):
    ...
    """
    if name == "RootEditorStateMixin":
        from .editor_state import RootEditorStateMixin

        globals()["RootEditorStateMixin"] = RootEditorStateMixin
        return RootEditorStateMixin
