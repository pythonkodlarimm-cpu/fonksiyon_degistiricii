# -*- coding: utf-8 -*-
"""
DOSYA: app/ui/root_paketi/root/root_akisi/dil_yardimcilari/yonetici.py

ROL:
- Dil yardımcı akışı için tek noktadan erişim sağlayan yönetici sınıfıdır
- Root dil yardımcı mixin sınıfını güvenli biçimde döndürür
...
MİMARİ:
- Yönetici sınıfı modül seviyesinde importu zorunlu kılmaz
...
- Paket erişim yapısı gelecekte genişletilmeye uygundur

KULLANIM:
- yonetici = RootDilYardimcilariYoneticisi()
...
- Sadece ilgili modül/sınıf erişimini merkezi hale getirir
- ilk başarılı import sonrası tekrar import maliyeti oluşmaz
...
class RootDilYardimcilariYoneticisi:
    """
    Dil yardımcı modülü için merkezi erişim yöneticisi.
    """

    modul_yolu = "app.ui.root_paketi.root.root_akisi.dil_yardimcilari.dil_yardimcilari"
    sinif_adi = "RootDilYardimcilariMixin"
    ...
    def _yukle_modul(self):
        ...
        try:
            ...
            print(f"[ROOT_DIL_YARDIMCILARI] Modül yüklenemedi: {self.modul_yolu}")
    ...
    def modul(self):
        """
        Dil yardımcı modül nesnesini döndürür.
    ...
    def mixin_sinifi(self):
        """
        RootDilYardimcilariMixin sınıfını döndürür.
