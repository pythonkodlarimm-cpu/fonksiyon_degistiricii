# -*- coding: utf-8 -*-
"""
DOSYA: app/ui/root_paketi/root/root_akisi/ui_kurulumu/yonetici.py

ROL:
- UI kurulum akışı için tek noktadan erişim sağlayan yönetici sınıfıdır
- Root UI kurulum mixin sınıfını güvenli biçimde döndürür
...
KULLANIM:
- yonetici = RootUiKurulumuYoneticisi()
...
class RootUiKurulumuYoneticisi:
    """
    UI kurulum modülü için merkezi erişim yöneticisi.
    """

    modul_yolu = "app.ui.root_paketi.root.root_akisi.ui_kurulumu.ui_kurulumu"
    sinif_adi = "RootUiKurulumuMixin"
    ...
    def _yukle_modul(self):
        ...
        try:
            ...
            print(f"[ROOT_UI_KURULUMU] Modül yüklenemedi: {self.modul_yolu}")
    ...
    def _yukle_sinif(self):
        ...
        try:
            ...
            if cls is None:
                print(f"[ROOT_UI_KURULUMU] Sınıf bulunamadı: {self.sinif_adi}")
                self._sinif_cache_temizle()
                return None
            ...
            print(f"[ROOT_UI_KURULUMU] Sınıf alınamadı: {self.sinif_adi}")
            print(traceback.format_exc())
            self._sinif_cache_temizle()
            return None
    ...
    def modul(self):
        """
        UI kurulum modül nesnesini döndürür.
    ...
    def mixin_sinifi(self):
        """
        RootUiKurulumuMixin sınıfını döndürür.
    ...
    def ornek_olustur(self, *args, **kwargs):
        ...
        try:
            ...
            print("[ROOT_UI_KURULUMU] Mixin örneği oluşturulamadı.")
            print(traceback.format_exc())
            return None