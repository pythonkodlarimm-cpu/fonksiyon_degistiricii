# -*- coding: utf-8 -*-
"""
DOSYA: app/ui/root_paketi/root/root_akisi/ui_kurulumu/__init__.py

ROL:
- ui_kurulumu paketinin dışa açılan ana giriş noktasıdır
- Root UI kurulum mixin sınıfını lazy import ile erişilebilir kılar
...
KULLANIM:
- from app.ui.root_paketi.root.root_akisi.ui_kurulumu import RootUiKurulumuMixin
...
def __getattr__(name: str):
    ...
    """
    if name == "RootUiKurulumuMixin":
        from .ui_kurulumu import RootUiKurulumuMixin

        globals()["RootUiKurulumuMixin"] = RootUiKurulumuMixin
        return RootUiKurulumuMixin
