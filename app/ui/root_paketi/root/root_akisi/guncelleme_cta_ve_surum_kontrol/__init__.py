# -*- coding: utf-8 -*-
"""
DOSYA: app/ui/root_paketi/root/root_akisi/guncelleme_cta_ve_surum_kontrol/__init__.py

ROL:
- guncelleme_cta_ve_surum_kontrol paketinin dışa açılan ana giriş noktasıdır
- Root güncelleme CTA ve sürüm kontrol mixin sınıfını lazy import ile erişilebilir kılar
...
KULLANIM:
- from app.ui.root_paketi.root.root_akisi.guncelleme_cta_ve_surum_kontrol import RootGuncellemeCtaVeSurumKontrolMixin
...
__all__ = ["RootGuncellemeCtaVeSurumKontrolMixin"]
...
def __getattr__(name: str):
    ...
    """
    if name == "RootGuncellemeCtaVeSurumKontrolMixin":
        from .guncelleme_cta_ve_surum_kontrol import (
            RootGuncellemeCtaVeSurumKontrolMixin,
        )

        globals()[
            "RootGuncellemeCtaVeSurumKontrolMixin"
        ] = RootGuncellemeCtaVeSurumKontrolMixin
        return RootGuncellemeCtaVeSurumKontrolMixin
