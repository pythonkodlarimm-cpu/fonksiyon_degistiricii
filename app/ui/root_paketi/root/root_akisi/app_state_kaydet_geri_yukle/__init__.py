# -*- coding: utf-8 -*-
"""
DOSYA: app/ui/root_paketi/root/root_akisi/app_state_kaydet_geri_yukle/__init__.py

ROL:
- app_state_kaydet_geri_yukle paketinin dışa açılan ana giriş noktasıdır
- Root app state kaydet / geri yükle mixin sınıfını lazy import ile erişilebilir kılar
...
KULLANIM:
- from app.ui.root_paketi.root.root_akisi.app_state_kaydet_geri_yukle import RootAppStateKaydetGeriYukleMixin
...
__all__ = ["RootAppStateKaydetGeriYukleMixin"]
...
def __getattr__(name: str):
    ...
    """
    if name == "RootAppStateKaydetGeriYukleMixin":
        from .app_state_kaydet_geri_yukle import RootAppStateKaydetGeriYukleMixin

        globals()["RootAppStateKaydetGeriYukleMixin"] = (
            RootAppStateKaydetGeriYukleMixin
        )
        return RootAppStateKaydetGeriYukleMixin
