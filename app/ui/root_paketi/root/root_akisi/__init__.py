# -*- coding: utf-8 -*-
"""
DOSYA: app/ui/root_paketi/root/root_akisi/__init__.py

ROL:
- root_akisi paketinin dışa açılan ana giriş noktasıdır
- RootAkisiYoneticisi sınıfını lazy import ile erişilebilir kılar
...
- Alt akışlara doğrudan değil, yonetici.py üzerinden erişim hedeflenir

KULLANIM:
- from app.ui.root_paketi.root.root_akisi import RootAkisiYoneticisi

NOT:
- Bu paket alt modülleri doğrudan yüklemez
- Merkezi erişim noktası yonetici.py dosyasıdır
...
def __getattr__(name: str):
    ...
    if name == "RootAkisiYoneticisi":
        from .yonetici import RootAkisiYoneticisi
