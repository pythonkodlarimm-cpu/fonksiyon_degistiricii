...
class DosyaSecici(BoxLayout):
    ...
    def _open_popup(self, *_args):
        ...
        geri_btn.unbind(on_release=lambda *_: None)
        ana_depo_btn.unbind(on_release=lambda *_: None)
        yenile_btn.unbind(on_release=lambda *_: None)
        kapat_btn.unbind(on_release=lambda *_: None)
